<?php include 'inc/starkheader.php';?>
<div class="container2">
	...
	<div>
		<div class="row">
			<div>
				<img class="pic2" src="images/nedstark.jpg" alt="Ned Stark">
			</div>
			<div>
				<img class="pic4" src="images/iconstark.png" alt="icon stark">
			</div>
		</div>
	</div>
	...
	<div>
		<div class="row">
			<div>
				<img class="pic2" src="images/aryastark.jpg" alt="Ayra Stark">
			</div>
			<div>
				<img class="pic4" src="images/iconstark.png" alt="icon stark">
			</div>
	...
	<div>
		<div class="row">
			<div>
				<img class="pic2" src="images/sansastark.jpg" alt="Sansa Stark">
			</div>
			<div>
				<img class="pic4" src="images/iconstark.png" alt="icon stark">
			</div>
	...
	<div>
		<div class="row">
			<div>
				<img class="pic2" src="images/branstark.jpg" alt="Bran Stark">
			</div>
			<div>
				<img class="pic4" src="images/iconstark.png" alt="icon stark">
			</div>
	...
	<div class="box">
			<a class="fill" href="survey.html">Fill Out Survey!</a>
	</div>

	<div class="box">
			<a class="fill" href="targaryen.html">Next</a>	
	</div>
</div>
