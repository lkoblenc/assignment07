...
<html lang="en">
<head>
	<title>Game of Thrones|House Lannister</title>
</head>
<body>
	<header>
		<a href="index.php">
...
<?php include "inc/head.inc" ?>
	...
	<section>
		...
		<img src="images/houselannister.jpg" alt="House Lannister">
		<p>
	...
	<article>
		...
		<p>
			In A Game of Thrones (1996), Jaime is introduced as one of the Kingsguard, the royal security detail, and the son of wealthy and powerful Tywin Lannister, the former Hand of the King. Jaime's twin is Cersei, the Queen of Westeros by virtue of her marriage to King Robert Baratheon. Perhaps the greatest swordsman in the kingdom, Jaime is sometimes derisively called "the Kingslayer" because he killed the "Mad King" Aerys Targaryen in the coup that put Robert on the Iron Throne.
		</p>
		<p>
