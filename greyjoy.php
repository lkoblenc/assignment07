...
<html lang="en">
<head>
	<title>Game of Thrones|House Greyjoy</title>
</head>
<body>
	<header>
		<a href="index.php">
...
<?php include "inc/head.inc" ?>
	...
	<section>
		<h1>House Greyjoy</h1>
		<img src="images/housegreyjoy.jpg" alt="House Greyjoy">
		<p>
		...
		<p>
			The Greyjoys of Pyke claim descent from the Grey King of the Age of Heroes. In the era when the ironborn chose their rulers through the kingsmoot, only Houses Greyiron and Goodbrother produced more kings than the Greyjoys. Greyjoys crowned King of the Iron Islands in a kingsmoot include Loron Greyjoy, Theon III Greyjoy, and Balon V Greyjoy. The iron lords, including the Greyjoys, intermarried with the victorious Andals when they invaded the Iron Isles.
		</p>
	</section>
	<article>
		<h2>Balon Greyjoy</h2>
		<img src="images/balon.jpg" alt="Balon Greyjoy">
		<p>
		...
		<h2>Euron Greyjoy</h2>
		<img src="images/euron.jpg" alt="Euron Greyjoy">
		<p>
		...
		<h2>Theon Greyjoy</h2>
		<img src="images/theon.jpg" alt="Theon Greyjoy">
		<p>
		...
		<h2>Yara Greyjoy</h2>
		<img src="images/yara.jpg" alt="Yara Greyjoy">
		<p>
